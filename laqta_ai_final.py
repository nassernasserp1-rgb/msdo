    ...
    def call_groq_ai(self, prompt: str) -> Optional[str]:
        ...
        try:
            ...
            data = {
                ...
                "messages": [
                    {"role": "system", "content": "أنت خبير في تحليل المنتجات والأسعار في السوق المصري."},
...
أجب بـ JSON:
{{"brand": "العلامة", "quality": "ممتاز/جيد/متوسط", "keywords": ["كلمة1", "كلمة2"], "confidence": 0-100, "assessment": "تقييم"}}
"""
